...
def quick_sort(array : list):
    ...
    pivot = array[0]
    left = [value for value in array if value < pivot]
    middle = [value for value in array if value == pivot]
    right = [value for value in array if value > pivot]
