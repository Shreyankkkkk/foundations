...
if account_type == 2:
    ...
    passed_accounts = total_number_of_accounts - prop_lost

    print("Number of Accounts Failed (>= -8%)", prop_lost)
    print("Number of Accounts Not Failed", passed_accounts)
    print()

    for i in final_account_balances:
        if i < 1.06 * initial_account_size:
            passed_0 += 1
        elif 1.06 * initial_account_size <= i < 1.12 * initial_account_size:
            passed_6 += 1 
        elif 1.12 * initial_account_size <= i < 1.22 * initial_account_size:
            passed_12 += 1
        elif i >= 1.22 * initial_account_size:
            passed_22 += 1
    ...
    print(f"Failed Phase 1 : {(passed_0 / len(final_account_balances))*100} %")
    print(f"Failed Phase 2, Passed Phase 1 : {(passed_6 / len(final_account_balances))*100} %")
    print(f"Passed Phase 1 and Phase 2 : {(passed_12 / len(final_account_balances))*100} %" )
    print(f"Passed Both Phases and Received Payout : {(passed_22 / len(final_account_balances))*100} %")
