...
# ============================================================================
# VECTORIZED HELPER FUNCTIONS (UNCHANGED FROM ORIGINAL)
# ============================================================================
...
def vectorized_trade_simulation(n_trades, account_size, risk_levels, win_rate_base, 
    ...
    for i in range(n_trades):
        ...
        # Risk based on INITIAL account size
...
def plot_equity_curves_optimized():
    ...
    try:
        ...
        # OPTIONAL: Sample a few curves for visual context (stays fast)
        ...
        # Plot percentile bands (main visualization)
        ...
        plt.title(f'Monte Carlo Equity Curves - {len(all_equity_curves):,} Simulations (Vectorized)', 
...
def plot_rr_distribution_optimized():
    ...
    try:
        ...
        # Auto-switch to histogram for massive datasets
        ...
        if use_kde:
            ...
            # Histogram for massive datasets
...
# Call the optimized RR plotting
