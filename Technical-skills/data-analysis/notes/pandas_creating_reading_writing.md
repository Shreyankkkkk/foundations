...
Being able to create DataFrame or Series by hand is handy
However, most of the time
we will be working with data that already exists.

Data Can be stored in any number of different forms and formats

Basic of these formats is **CSV** file. 
When you open a **CSV** file you get
...
```python
variable_name = pd.read_csv("file location")
```